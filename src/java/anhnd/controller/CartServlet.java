...
private final String CONFIRM_CHECK_OUT_CONTROLLER = "ConfirmCheckOutServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = siteMaps.getProperty(MyApplicationConstants.CartProductFeature.ERROR_PAGE);
        
        try {
            if (action.equals("Remove Selected Books")) {
                url = siteMaps.getProperty(MyApplicationConstants.CartProductFeature.REMOVE_BOOK_FROM_CART);
            } else if (action.equals("Check Out Selected Books")) {
                url = siteMaps.getProperty(MyApplicationConstants.CartProductFeature.CONFIRM_CHECK_OUT_CONTROLLER);
            }
        } finally {
